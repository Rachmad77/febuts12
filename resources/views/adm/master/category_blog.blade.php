                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="form-blog-category">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name" class="form-label text-capitalize">Kategori Blog</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#form-blog-category').on('keydown', function(e) {
            if (e.key === "Enter") {
