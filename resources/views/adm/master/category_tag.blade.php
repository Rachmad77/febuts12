            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Kategori Tag</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal_formTitle">Kategori Tag
                                </h5>
                            ...
                            <div class="modal-body">
                                <form id="form-tag-category">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name" class="form-label text-capitalize">Kategori Tag</label>
                ...
                <div class="modal fade" id="recycle-form" tabindex="-1" role="dialog" aria-labelledby="modal_formTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modal_formTitle">Recycle Kategori Tag
                                </h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <i data-feather="x"></i>
                                </button>
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <table class="table" id="recycle-tag-category">
                                        <thead>
                                            <tr>
                ...
                <div class="table-responsive">
                    <table class="table" id="tag-category">
                        <thead>
                            <tr>
                                <th scope="col" class="text-center text-nowrap">No</th>
                                <th scope="col" class="text-start text-nowrap">Nama Kategori</th>
...
<script>
    $(document).ready(function() {
        ...
        $('#tag-category').DataTable({
            processing: true,
            ordering: false,
            serverside: false,
            ajax: {
                url: "{{  route('master.category_tag.index') }}",
                type: 'GET',
            },
            responsive: true,
            columns: [{
        ...
        $(document).on('click', '#btn-save', function(e) {
                ...
                $.ajax({
                    url: "{{ route('master.category_tag.store') }}",
                    type: "POST",
                    data: formData,
                    cache: false,
                    contentType: false,
                    ...
                    success: function(response) {
                        if (response.success) {
                            $('#tag-category').DataTable().ajax.reload();
        ...
        $('#tag-category').on("click", "#btn-edit", function(e) {
            let id = $(this).data("id");

            $.ajax({
                url: '{{ url("master/category_tag") }}' + id,
                type: 'GET',
                success: function(response) {
        ...
        $('#form-tag-category').on('keydown', function(e) {
            if (e.key === "Enter") {
        ...
        $('#show-recycle-form').click(function(e) {
            ...
            $(document).on('click', '.btn-restore', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("master/category_tag/restore") }}' + id,
                            type: 'PUT',
            ...
            $(document).on('click', '.btn-force-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url("master/category_tag/force-delete") }}' + id,
                            type: 'DELETE',
                            data: {
                                _token: "{{ csrf_token() }}"
                            },
